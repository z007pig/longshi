...
import GoodsItemComponent from '../ShopCart/GoodsItem';
        ...
        <ScrollView style={{flex:1}}>
          ...
          <View style={styles.pay_info}>
            <View style={styles.pay_info_item}>
              ...
              <Image source={require('./assets/icon_Get into3.png')}/>
            </View>
            <TouchableOpacity style={styles.pay_info_item} onPress={this._changeState.bind(this)}>
              ...
              {this.state.userintegral
                ? <Image source={require('./assets/check_n.png')} style={styles.check}/>
                : <Image source={require('./assets/check_dis.png')} style={styles.check}/>
              }
            </TouchableOpacity>
