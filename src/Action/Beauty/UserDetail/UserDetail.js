...
import DiaryListItemComponent from '../../../BaseView/DiaryListItem/DiaryListItem';
          ...
          <View style={styles.header}>
            ...
            <View style={styles.info_box}>
              <View style={styles.info_item}>
                <Image source={require('../assets/icon_female2.png')} style={styles.info_icon}/>
                <Text style={styles.info_content}>女</Text>
              </View>
              <View style={styles.info_item}>
                <Image source={require('../assets/icon_Birthday.png')} style={styles.info_icon}/>
              ...
              <View style={[styles.info_item, {paddingRight:0,marginRight:0,borderRightWidth:0}]}>
                <Image source={require('../assets/icon_place.png')} style={styles.info_icon}/>
          ...
          >
            ...
            <View tabLabel='TA的日记本' style={{flex:1}}>
              <View style={{
                ...
                <View style={styles.item}>
                  <DiaryListItemComponent nav={this.props.nav}/>
                </View>
                <View style={styles.item}>
                  <DiaryListItemComponent nav={this.props.nav}/>
                </View>
