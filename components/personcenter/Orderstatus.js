...
export default class OrderstatusComponent extends Component {
  ...
  renderItem(){
    ...
    for (var i = 0; i < this.state.data.length; i++) {
      ...
      // if (i % 2 == 0) {
      //   item = <OrderstatusItem key={i} navigator={this.props.navigator} state={'open'}/>
      // } else {
      //   item = <OrderstatusItem key={i} navigator={this.props.navigator} state={'close'}/>
      // }
      item = <OrderstatusItem key={i} navigator={this.props.navigator} state={this.state.data[i].state}/>
      items.push(
        item
      )
    }
  ...
  render () {
    return (
      <View style={styles.wrapper}>
        <TopNavComponent title="订单状态" navigator={this.props.navigator}/>
        ...
        <ScrollView>
          <View>
            {/* <OrderstatusItem navigator={this.props.navigator}/> */}
            {this.renderItem()}
          </View>
        </ScrollView>
      </View>
