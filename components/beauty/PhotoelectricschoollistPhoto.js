    ...
    return (
      <View style={styles.wrapper}>
        <View style={styles.list_img_box}>
          <Image style={styles.list_img} source={require('./image/WX20170328-110633.png')}/>
        </View>
        <View style={styles.list_text_box}>
          ...
          <View style={styles.list_text_box_footer_item}>
            <Image source={require('./image/icon_time.png')}/>
            <Text style={{marginLeft: 6}}>2017.3.28</Text>
            <Image style={{marginLeft: 30}} source={require('./image/icon_see2.png')}/>
