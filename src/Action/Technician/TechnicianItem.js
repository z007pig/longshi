...
export default class TechnicianItemComponent extends Component {
  ...
  render () {
    return (
      <TouchableOpacity style={[styles.item, {width:this.props.width}]} onPress={this._goUserDetail.bind(this)}>
        <View style={{
          ...
          }} source={require('../Beauty/assets/g.jpg')}/>
        </View>
        ...
        <View style={styles.item_content}>
          <View style={styles.item_title}>
            ...
            <Image style={styles.item_sex} source={require('../Beauty/assets/icon_female.png')}/>
          </View>
